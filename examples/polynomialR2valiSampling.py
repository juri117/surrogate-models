...
if __name__ == '__main__':
    ...
    polyPlot.save('../dataOut/plot/polynomialR2sampling.pdf')


    # plot validation
    valiPlot = PlotHelper(['Sampling Punkte', 'Wert'], fancy=True, pgf=True)
    ...
    valiPlot.ax.plot(sampling_points, np.array([r.press for r in vali_res]) * 0.1, 'k-', label=r'$PRESS * 0.1$')
    ...
    polyPlot.save('../dataOut/plot/polynomialR2valiSampling.pdf')
    valiPlot.show()
