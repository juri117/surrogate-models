...
class MultiRun:
    ...
    def new_project_r_t(self, rib, thick, element_size=0.1):
        ...
        rib = int(rib)
        project_name = self.project_name_prefix + '_r{:02d}_t{:.6f}'.format(rib, thick*1000)
...
if __name__ == '__main__':
    ...
    # output_file_name = '/data_out/newRun/2drun_2018-08-10_12_07_48.csv'
    output_file_name = '/data_out/oldRun/2drun_2018-08-10_12_13_55.csv'
